...
import 'package:mvvm/ui/custom_snack_bar.dart';
...
extension ThemeModeExtension on BuildContext {
  ...
  ThemeData get lightTheme => ThemeData.light().copyWith(
    ...
    colorScheme: Theme.of(
      this,
    ).colorScheme.copyWith(brightness: Brightness.light, primary: AppColors.blueberry100, error: AppColors.rambutan100),
  ...
  ThemeData get darkTheme => ThemeData.dark().copyWith(
    ...
    colorScheme: Theme.of(
      this,
    ).colorScheme.copyWith(brightness: Brightness.dark, primary: AppColors.blueberry100, error: AppColors.rambutan100),
